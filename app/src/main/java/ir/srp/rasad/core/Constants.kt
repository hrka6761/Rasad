...
object Constants {
    ...
    const val USER_FORCE_RUN_INFO_KEY = "userForceRunInfo"
    ...
    const val START_SERVICE_OBSERVABLE = "start_observable"
    const val START_SERVICE_OBSERVER = "start_observer"
    const val STOP_SERVICE_OBSERVABLE = "stop_observable"
    const val STOP_SERVICE_OBSERVER = "stop_observer"
    const val FORCE_START_SERVICE_OBSERVABLE = "force_start_observer"
